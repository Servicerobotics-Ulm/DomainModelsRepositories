...
//--------------------------------------------------------------------------
#ifndef DOMAINEXTERNALSYSTEMS_COMMPROGRAMLIST_ACE_H_
#define DOMAINEXTERNALSYSTEMS_COMMPROGRAMLIST_ACE_H_

#include "DomainExternalSystems/CommProgramList.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommProgramList
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const DomainExternalSystemsIDL::CommProgramList &data);

// de-serialization operator for DataStructure CommProgramList
...
#endif /* DOMAINEXTERNALSYSTEMS_COMMPROGRAMLIST_ACE_H_ */
