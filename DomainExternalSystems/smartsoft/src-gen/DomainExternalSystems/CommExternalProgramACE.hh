...
//--------------------------------------------------------------------------
#ifndef DOMAINEXTERNALSYSTEMS_COMMEXTERNALPROGRAM_ACE_H_
#define DOMAINEXTERNALSYSTEMS_COMMEXTERNALPROGRAM_ACE_H_

#include "DomainExternalSystems/CommExternalProgram.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommExternalProgram
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const DomainExternalSystemsIDL::CommExternalProgram &data);

// de-serialization operator for DataStructure CommExternalProgram
...
#endif /* DOMAINEXTERNALSYSTEMS_COMMEXTERNALPROGRAM_ACE_H_ */
