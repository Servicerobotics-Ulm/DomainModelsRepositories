...
CommBasicObjects::CommVoid ExternalProgamCoordinationServiceProgramListQueryQueryHandler::handleRequest(const std::string& inString){
...
std::string ExternalProgamCoordinationServiceProgramListQueryQueryHandler::handleAnswer(const DomainExternalSystems::CommProgramList& answer){
