...
// serialization for CommExternalProgramArgument
template <>
inline IDescription::shp_t SelfDescription(DomainExternalSystems::CommExternalProgramArgument *obj, std::string name)
{
