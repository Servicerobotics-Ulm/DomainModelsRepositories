...
// serialization for CommExternalProgramResponse
template <>
inline IDescription::shp_t SelfDescription(DomainExternalSystems::CommExternalProgramResponse *obj, std::string name)
{
