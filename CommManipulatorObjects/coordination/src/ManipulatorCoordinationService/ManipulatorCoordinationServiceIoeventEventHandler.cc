...
std::string ManipulatorCoordinationServiceIoeventEventHandler::handleEvent(const CommBasicObjects::CommDigitalInputEventResult &r) throw() {
...
CommBasicObjects::CommDigitalInputEventParameter ManipulatorCoordinationServiceIoeventEventHandler::activateEventParam(const std::string& parameterString){
