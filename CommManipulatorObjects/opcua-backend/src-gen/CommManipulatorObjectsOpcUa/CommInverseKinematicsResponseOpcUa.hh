...
// serialization for CommInverseKinematicsResponse
template <>
inline IDescription::shp_t SelfDescription(CommManipulatorObjects::CommInverseKinematicsResponse *obj, std::string name)
{
