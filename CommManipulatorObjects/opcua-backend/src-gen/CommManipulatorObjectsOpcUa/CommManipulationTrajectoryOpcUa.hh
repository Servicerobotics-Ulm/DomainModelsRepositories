...
// serialization for CommManipulationTrajectory
template <>
inline IDescription::shp_t SelfDescription(CommManipulatorObjects::CommManipulationTrajectory *obj, std::string name)
{
