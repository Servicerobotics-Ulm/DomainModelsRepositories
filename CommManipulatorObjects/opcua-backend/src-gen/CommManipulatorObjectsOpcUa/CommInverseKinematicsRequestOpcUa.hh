...
// serialization for CommInverseKinematicsRequest
template <>
inline IDescription::shp_t SelfDescription(CommManipulatorObjects::CommInverseKinematicsRequest *obj, std::string name)
{
