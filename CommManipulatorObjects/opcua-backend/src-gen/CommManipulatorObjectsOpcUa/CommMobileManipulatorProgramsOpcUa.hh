...
// serialization for CommMobileManipulatorPrograms
template <>
inline IDescription::shp_t SelfDescription(CommManipulatorObjects::CommMobileManipulatorPrograms *obj, std::string name)
{
