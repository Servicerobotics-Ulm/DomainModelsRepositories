...
// serialization for CommCartesianManipulationTarget
template <>
inline IDescription::shp_t SelfDescription(CommManipulatorObjects::CommCartesianManipulationTarget *obj, std::string name)
{
