...
// serialization for CommJointManipulationTarget
template <>
inline IDescription::shp_t SelfDescription(CommManipulatorObjects::CommJointManipulationTarget *obj, std::string name)
{
