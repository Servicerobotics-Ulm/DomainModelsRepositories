...
//--------------------------------------------------------------------------
#ifndef COMMMANIPULATOROBJECTS_COMMCARTESIANMANIPULATIONTARGET_ACE_H_
#define COMMMANIPULATOROBJECTS_COMMCARTESIANMANIPULATIONTARGET_ACE_H_

#include "CommManipulatorObjects/CommCartesianManipulationTarget.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommCartesianManipulationTarget
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommManipulatorObjectsIDL::CommCartesianManipulationTarget &data);

// de-serialization operator for DataStructure CommCartesianManipulationTarget
...
#endif /* COMMMANIPULATOROBJECTS_COMMCARTESIANMANIPULATIONTARGET_ACE_H_ */
