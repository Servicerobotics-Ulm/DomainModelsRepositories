...
//--------------------------------------------------------------------------
#ifndef COMMMANIPULATOROBJECTS_COMMVACUUMGRIPPEREVENTRESULT_ACE_H_
#define COMMMANIPULATOROBJECTS_COMMVACUUMGRIPPEREVENTRESULT_ACE_H_

#include "CommManipulatorObjects/CommVacuumGripperEventResult.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommVacuumGripperEventResult
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommManipulatorObjectsIDL::CommVacuumGripperEventResult &data);

// de-serialization operator for DataStructure CommVacuumGripperEventResult
...
#endif /* COMMMANIPULATOROBJECTS_COMMVACUUMGRIPPEREVENTRESULT_ACE_H_ */
