...
//--------------------------------------------------------------------------
#ifndef COMMMANIPULATOROBJECTS_COMMGRASP_ACE_H_
#define COMMMANIPULATOROBJECTS_COMMGRASP_ACE_H_

#include "CommManipulatorObjects/CommGrasp.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommGrasp
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommManipulatorObjectsIDL::CommGrasp &data);

// de-serialization operator for DataStructure CommGrasp
...
#endif /* COMMMANIPULATOROBJECTS_COMMGRASP_ACE_H_ */
