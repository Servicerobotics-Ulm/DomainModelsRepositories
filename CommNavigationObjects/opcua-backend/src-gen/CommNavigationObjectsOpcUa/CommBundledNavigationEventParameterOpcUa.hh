...
// serialization for CommBundledNavigationEventParameter
template <>
inline IDescription::shp_t SelfDescription(CommNavigationObjects::CommBundledNavigationEventParameter *obj, std::string name)
{
