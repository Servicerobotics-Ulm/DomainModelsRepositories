...
// serialization for CommBundledNavigationEventState
template <>
inline IDescription::shp_t SelfDescription(CommNavigationObjects::CommBundledNavigationEventState *obj, std::string name)
{
