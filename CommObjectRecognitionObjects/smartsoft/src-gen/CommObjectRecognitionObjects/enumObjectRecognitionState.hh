...
namespace CommObjectRecognitionObjects {
	...
	public:
		...
		static ObjectRecognitionState from_string(const std::string &value) {
			...
			std::string base_name = "objectrecognitionstate::";
