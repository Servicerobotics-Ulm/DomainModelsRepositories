...
//--------------------------------------------------------------------------
#ifndef COMMOBJECTRECOGNITIONOBJECTS_COMMPICKDETECTIONREQUEST_ACE_H_
#define COMMOBJECTRECOGNITIONOBJECTS_COMMPICKDETECTIONREQUEST_ACE_H_

#include "CommObjectRecognitionObjects/CommPickDetectionRequest.hh"

#include <ace/CDR_Stream.h>

// serialization operator for DataStructure CommPickDetectionRequest
ACE_CDR::Boolean operator<<(ACE_OutputCDR &cdr, const CommObjectRecognitionObjectsIDL::CommPickDetectionRequest &data);

// de-serialization operator for DataStructure CommPickDetectionRequest
...
#endif /* COMMOBJECTRECOGNITIONOBJECTS_COMMPICKDETECTIONREQUEST_ACE_H_ */
