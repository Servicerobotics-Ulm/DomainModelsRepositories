...
// serialization for CommImageObjectRecognitionResults
template <>
inline IDescription::shp_t SelfDescription(CommObjectRecognitionObjects::CommImageObjectRecognitionResults *obj, std::string name)
{
