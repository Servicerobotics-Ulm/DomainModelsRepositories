...
// serialization for CommImageObjectRecognitionResult
template <>
inline IDescription::shp_t SelfDescription(CommObjectRecognitionObjects::CommImageObjectRecognitionResult *obj, std::string name)
{
