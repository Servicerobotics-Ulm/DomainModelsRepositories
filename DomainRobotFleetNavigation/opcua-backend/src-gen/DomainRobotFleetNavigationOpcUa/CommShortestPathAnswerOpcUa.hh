...
// serialization for CommShortestPathAnswer
template <>
inline IDescription::shp_t SelfDescription(DomainRobotFleetNavigation::CommShortestPathAnswer *obj, std::string name)
{
