...
// serialization for CommNodeStatusUpdateRequest
template <>
inline IDescription::shp_t SelfDescription(DomainRobotFleetNavigation::CommNodeStatusUpdateRequest *obj, std::string name)
{
