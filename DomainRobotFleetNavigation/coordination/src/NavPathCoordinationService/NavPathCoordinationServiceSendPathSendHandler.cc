...
DomainRobotFleetNavigation::CommNavPath NavPathCoordinationServiceSendPathSendHandler::handleSend(std::string inString){

	// (2 (1 1 2.5 (2 (1 2.0 3.0 1) (1 2.0 3.0 1))) (2 1 2.5 (2 (1 2.0 3.0 1) (1 2.0 3.0 1))))

	std::cout << "timo navpath inString: " << inString << std::endl;

	DomainRobotFleetNavigation::CommNavPath sendCommObject;
	...
	std::vector<DomainRobotFleetNavigation::CommPath> paths;
