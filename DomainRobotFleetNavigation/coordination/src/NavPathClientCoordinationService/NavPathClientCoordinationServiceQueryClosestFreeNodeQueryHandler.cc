#include "NavPathClientCoordinationServiceQueryClosestFreeNodeQueryHandler.hh"
...
CommBasicObjects::CommPosition3d NavPathClientCoordinationServiceQueryClosestFreeNodeQueryHandler::handleRequest(const std::string& inString){
...
std::string NavPathClientCoordinationServiceQueryClosestFreeNodeQueryHandler::handleAnswer(const DomainRobotFleetNavigation::CommNode& answer){
	//nlohmann::json data;
