...
std::string FestoMPSDockingCoordinationServiceDockingeventEventHandler::handleEvent(const CommRobotinoObjects::CommRobotinoDockingEventResult &r) throw() {
...
CommRobotinoObjects::CommRobotinoDockingEventParameter FestoMPSDockingCoordinationServiceDockingeventEventHandler::activateEventParam(const std::string& parameterString){
