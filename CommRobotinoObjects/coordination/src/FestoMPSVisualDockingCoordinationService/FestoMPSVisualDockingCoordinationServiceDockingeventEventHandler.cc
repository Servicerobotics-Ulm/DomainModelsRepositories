...
std::string FestoMPSVisualDockingCoordinationServiceDockingeventEventHandler::handleEvent(const CommRobotinoObjects::CommRobotinoDockingEventResult &r) throw() {
...
CommRobotinoObjects::CommRobotinoDockingEventParameter FestoMPSVisualDockingCoordinationServiceDockingeventEventHandler::activateEventParam(const std::string& parameterString){
