...
namespace CommBasicObjects {
	...
	public:
		...
		static FileType from_string(const std::string &value) {
			...
			if(input == "file_regular"){
				return FileType(FILE_REGULAR);
			}
			if(input == "file_directory"){
